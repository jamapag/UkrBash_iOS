...
#import "UBPictureCollectionViewCellOld.h"

@implementation UBPictureCollectionViewCellOld
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        float imageWidth = self.frame.size.width - 20;
        if (imageWidth > 400) {
            imageWidth = 400;
        }
        imageView = [[UIImageView alloc] initWithFrame:CGRectMake(self.frame.size.width / 2 - (imageWidth / 2), 10, imageWidth, imageWidth)];
...
//        imageView.autoresizingMask = UIViewAutoresizingFlexibleHeight | UIViewAutoresizingFlexibleWidth;
        ...
        pictureTittleLabel = [[UILabel alloc] initWithFrame:CGRectMake(self.frame.size.width / 2 - (imageWidth / 2), imageWidth + 20, imageWidth, 65)];
        ...
        authorLabel = [[UILabel alloc] initWithFrame:CGRectMake(20, self.frame.size.height - 40, (self.frame.size.width - 40) / 2, 20)];
...
//    imageView.frame = CGRectMake(self.frame.size.width / 2 - 200, 10, 400, 400);
    ...
    imageView.frame = CGRectMake(self.frame.size.width / 2 - (imageWidth / 2), 10, imageWidth, imageWidth);
}
